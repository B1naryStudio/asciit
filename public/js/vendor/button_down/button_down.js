    ...
    jQuery(function($){
        ...
        $(window).scroll(function() {
            if($(window).scrollTop() >= 1) {
                topLink.fadeIn(300).children('a').html('<span id="topicon"></span>' + i18n.t('ui.up')).parent().removeClass('bottom_button').addClass('top_button');
            } else {
                topLink.children('a').html('<span id="backicon"></span>'  + i18n.t('ui.down')).parent().removeClass('top_button').addClass('bottom_button');
            }
        });
