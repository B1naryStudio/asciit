CKEDITOR.plugins.setLang( 'codewidget', 'ru', {
    jsFiddle: {
        buttonTitle:    "Добавить фрагмент кода с JSFiddle",
        urlValidation:  "Пожалуйста, введите корректную URL-ссылку на фрагмент " +
                        "кода с JSFiddle.",
        urlDescription: "Ссылка будет использована для создания виджета с " +
                        "фрагментом кода с JSFiddle."
    },
    gist: {
        buttonTitle:    "Добавить GitHub Gist",
