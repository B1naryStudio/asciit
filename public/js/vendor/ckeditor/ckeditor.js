...
(function() {
 ...
 (function() {
  function k(a) {
   ...
   } catch (h) {}(CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == d.document.$.compatMode) && this.attachListener(this, "keydown", function(a) {
    var b = a.data.getKeystroke();
    if (b == 33 || b == 34)
 ...
 (function() {
  ...
  function v(b) {
   function a() {
    ...
    a.on(l.mainPasteEvent, function(b) {
     "beforepaste" == l.mainPasteEvent && m || i(b)
    });
    "beforepaste" == l.mainPasteEvent && (a.on("paste", function(a) {
     r || (e(), a.data.preventDefault(), i(a), f("paste") || b.openDialog("paste"))
    ...
    return {
     ...
     exec: function(b, a) {
      ...
      "string" == typeof a ? d({
       dataValue: a,
       method: "paste",
       dataTransfer: l.initPasteDataTransfer()
   ...
   function j(a, d) {
    ...
    if (!c.getById("cke_pastebin")) {
     ...
     var k = new CKEDITOR.dom.element((CKEDITOR.env.webkit ||
     ...
     var i = 0,
         c = c.getWindow();
     CKEDITOR.env.webkit ? (e.append(k), k.addClass("cke_editable"), e.is("body") || (i = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), i = i.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k);
     k.setStyles({
      position: "absolute",
      top: c.getScrollPosition().y - i + 10 + "px",
      width: "1px",
     ...
     (i = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute("contenteditable", !0)) : k.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-1000px");
   ...
   function s() {
    ...
    a.lock();
    if (b.editable().fire(l.mainPasteEvent) && !f("paste")) return a.unlock(), !1;
    a.unlock();
    return !0
   }
   ...
   function n(a) {
    if ("wysiwyg" == b.mode) switch (a.data.keyCode) {
     ...
     case CKEDITOR.SHIFT + 45:
      a = b.editable();
      e();
      "paste" == l.mainPasteEvent && a.fire("beforepaste");
      break;
   ...
   function i(a) {
    ...
    c && l.canClipboardApiBeTrusted(d.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function() {
     o(b, d)
    }, 0)) : j(a, function(a) {
   ...
   var l = CKEDITOR.plugins.clipboard,
       m = 0,
       r = 0,
       t = 0;
   (function() {
   ...
   b.getClipboardData = function(a, d) {
    ...
    !1 === s() && (b.removeListener("paste", c), n && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide", function(a) {
     a.removeListener();
  ...
  function x(b, a) {
   ...
   (a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g, function(a) {
        return c(a.length / 4)
       }) + "</p>"));
   return y(b, a)
  }
  ...
  function B(b) {
   ...
   b.on("contentDom", function() {
    ...
    var f = b.editable(),
        ...
        j = b.ui.space("top"),
        s = b.ui.space("bottom");
    a.preventDefaultDropOnElement(j);
   ...
   init: function(b) {
    ...
    b.on("paste", function(a) {
         ...
         if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
          var f, h, j = new CKEDITOR.dom.element("div");
          for (j.setHtml(b); 1 == j.getChildCount() && (f =
              j.getFirst()) && f.type == CKEDITOR.NODE_ELEMENT && (f.hasClass("cke_editable") || f.hasClass("cke_contents"));) j = h = f;
    ...
    b.on("paste", function(a) {
     var a = a.data,
         ...
         j = a.dataTransfer.getTransferType(b);
     f = "html" == e || "html" == a.preSniffing ? "html" : w(g);
     "htmlifiedtext" == f && (g = x(b.config, g));
     "text" == e && "html" == f ? g = u(b, g, c.get("plain-text")) : j == CKEDITOR.DATA_TRANSFER_EXTERNAL && (b.pasteFilter && !a.dontFilter) && (g = u(b, g, b.pasteFilter));
  ...
  CKEDITOR.plugins.clipboard = {
   ...
   getRangeAtDropPosition: function(b, a) {
    ...
    if (document.caretRangeFromPoint) c =
        a.document.$.caretRangeFromPoint(d, e), f.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), f.collapse(!0);
     ...
     if (document.body.createTextRange) {
      ...
      try {
       for (var h = !1, j = 0; 20 > j && !h; j++) {
        if (!h) try {
         c.moveToPoint(d, e - j), h = !0
        } catch (m) {}
        if (!h) try {
         c.moveToPoint(d, e + j), h = !0
        } catch (n) {}
       ...
       if (h) {
        ...
        c.pasteHTML('<span id="' + i + '">​</span>');
        var p = a.document.getById(i);
        f.moveToPosition(p, CKEDITOR.POSITION_BEFORE_START);
        p.remove()
       } else {
        var q = a.document.$.elementFromPoint(d, e),
            l = new CKEDITOR.dom.element(q),
            o;
        if (!l.equals(a.editable()) && "html" != l.getName()) o = l.getClientRect(), d < o.left ? f.setStartAt(l, CKEDITOR.POSITION_AFTER_START) : f.setStartAt(l, CKEDITOR.POSITION_BEFORE_END), f.collapse(!0);
        else return g && g.startContainer && !g.startContainer.equals(a.editable()) ? g : null
       }
      } catch (r) {
       return null
      }
 ...
 CKEDITOR.plugins.add("SimpleLink", {
  icons: "simplelink",
  init: function(a) {
   a.addCommand("simplelink", new CKEDITOR.dialogCommand("simplelinkDialog"));
   a.ui.addButton("SimpleLink", {
    label: "Add a link",
    icons: "simplelink",
    command: "simplelink"
   });
  ...
  k.prototype = {
   start: function(a) {
    var d = this,
        b = this.editor,
        c = this.doc,
        e, g, f, h, i = CKEDITOR.tools.eventsBuffer(50, function() {
         if (!(b.readOnly || "wysiwyg" != b.mode))
          if (d.relations = {}, (g = c.$.elementFromPoint(f, h)) && g.nodeType) e = new CKEDITOR.dom.element(g), d.traverseSearch(e), isNaN(f + h) || d.pixelSearch(e, f, h), a && a(d.relations, f, h)
        });
   ...
   greedySearch: function() {
    ...
    for (var a = this.editable.getElementsByTag("*"), d = 0, b, c, e; b = a.getItem(d++);)
     if (!b.equals(this.editable) && b.type == CKEDITOR.NODE_ELEMENT && (b.hasAttribute("contenteditable") || !b.isReadOnly()) && j(b) && b.isVisible())
 ...
 (function() {
    ...
    exec: function(a, d) {
     ...
     if (f && f.name == b.name) f.edit();
      ...
      var f = "function" == typeof b.defaults ? b.defaults() : b.defaults,
          ...
          g, j = a.widgets.wrapElement(f, b.name),
   ...
   return {
    ...
    iterator: function(a) {
     ...
     if (l = c.length) {
      ...
      i = 0;
      for (f = d.length; i < f; ++i)
       if (!1 === d[i](a)) return;
      for (i = 0; i < l; ++i)
       if (f =
               c[i], j = {}, g = f[0](a, j)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(j)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1
     }
    }
   }
  }
  ...
  function I(a) {
   ...
   b.on("drop", function(c) {
    ...
    if (!("" === f || e.getTransferType(b) != CKEDITOR.DATA_TRANSFER_INTERNAL))
     if (e = a.instances[f]) g.setStartBefore(e.wrapper), g.setEndAfter(e.wrapper), c.data.dragRange = g, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount, delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount,
         c.data.dataTransfer.setData("text/html", b.editable().getHtmlFromRange(g).getHtml()), b.widgets.destroy(e, !0)
   });
   b.on("contentDom", function() {
    var d = b.editable();
  ...
  function G(a) {
   ...
   b.on("contentDom", function() {
    ...
    c.attachListener(d, "mousedown", function(b) {
     ...
     e = a.getByElement(c);
     f = 0;
     e && (e.inline && c.type == CKEDITOR.NODE_ELEMENT && c.hasAttribute("data-cke-widget-drag-handler") ? f = 1 : h.getNestedEditable(e.wrapper, c) ? e = null : (b.data.preventDefault(), CKEDITOR.env.ie || e.focus()))
    });
  ...
  function H(a) {
   a.editor.on("key", function(b) {
    ...
    }) : d && (c = b.data.keyCode, b = d.focusedEditable, c == CKEDITOR.CTRL + 65 ? (c = b.getBogus(), d = d.editor.createRange(), d.selectNodeContents(b), c && d.setEndAt(c, CKEDITOR.POSITION_BEFORE_START), d.select(), e = !1) : 8 == c || 46 == c ? (e = d.editor.getSelection().getRanges(),
  ...
  function F(a) {
   ...
   b.on("selectionChange", function(c) {
    var d = (c = h.getNestedEditable(b.editable(),
                c.data.selection.getStartElement())) && a.getByElement(c),
   ...
   b.on("toDataFormat", function(b) {
    ...
    b.data.dataValue.forEach(function(b) {
     ...
     if ("data-cke-widget-id" in c) {
      if (c = a.instances[c["data-cke-widget-id"]]) d = b.getFirst(h.isParserWidgetElement), f.push({
       wrapper: b,
       element: d,
       widget: c,
       editables: {}
  ...
  function C(a) {
   ...
   b.on("toHtml", function(b) {
    ...
    for (b.data.dataValue.forEach(d.iterator, CKEDITOR.NODE_ELEMENT, !0); g = d.toBeWrapped.pop();) {
     ...
     i.attributes["data-cke-widget-wrapper"] && i.replaceWith(j);
   ...
   b.on("dataReady", function() {
    if (d)
     for (var c = b.editable().find(".cke_widget_wrapper"), f, g, j = 0, i = c.count(); j < i; ++j) f = c.getItem(j), g = f.getFirst(h.isDomWidgetElement), g.type == CKEDITOR.NODE_ELEMENT &&
     g.data("widget") ? (g.replace(f), a.wrapElement(g)) : f.remove();
    d = 0;
    a.destroyAll(!0);
    a.initOnAll()
   });
  ...
  function w(a) {
   ...
   return {
    ...
    commit: function() {
     ...
     for (f && (g = a.focused) && q(a, g); g = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, g), 1), g.isInited() && (h = g.editor.checkDirty(),
         g.setSelected(!1), !h && g.editor.resetDirty());
  ...
  function v(a, b) {
   ...
   if (!d.getById("cke_copybin")) {
    var e =
            c.blockless || CKEDITOR.env.ie ? "span" : "div",
        f = d.createElement(e),
        g = d.createElement(e),
  ...
  n.prototype = {
   ...
   initOn: function(a, b, c) {
    b ? "string" ==
    typeof b && (b = this.registered[b]) : b = this.registered[a.data("widget")];
    if (!b) return null;
  ...
  h.prototype = {
   ...
   initEditable: function(a, b) {
    ...
    return c && c.is(CKEDITOR.dtd.$editable) ? (c = new o(this.editor, c, {
     filter: r.call(this.repository, this.name, a, b)
 ...
 CKEDITOR.plugins.add("imageresize", {
  ...
  resizeAll: function(a, b, d, c) {
   if (this.support() && (b || (b = a.document), b))
    if (d || (d = this.config.maxWidth), c || (c = this.config.maxHeight), console.log(d + "x" + c), "find" in b && "function" == typeof b.find || (b = new CKEDITOR.dom.node(b)), b && "find" in b && "function" == typeof b.find) {
     var b = b.find("img"),
         e, h, f, g, i, j = b.count();
     for (i = 0; i < j; i++) {
      g = b.getItem(i);
  ...
  getConfig: function() {
   if (CKEDITOR.config.imageResize)
    for (var a in this.config)
     if (CKEDITOR.config.imageResize[a] && (this.config[a] = parseInt(CKEDITOR.config.imageResize[a], 10), isNaN(this.config[a]) || 1 > this.config[a])) this.config[a] = 800
  }
 });
 (function() {
  function e(b, a) {
 ...
 (function() {
  ...
  i.prototype = {
   ...
   attachRequestListeners: function() {
    ...
    b.onload = function() {
     a.uploaded = a.total;
     if (200 > b.status || 299 < b.status) a.message = a.lang.filetools["httpError" + b.status], a.message || (a.message = a.lang.filetools.httpError.replace("%1", b.status)), a.changeStatus("error");
     else {
      for (var c = {
       fileLoader: a
      }, d = ["message", "fileName",
       "url"
      ], f = a.editor.fire("fileUploadResponse", c), e = 0; e < d.length; e++) {
       var g = d[e];
 ...
 CKEDITOR.config.plugins = 'basicstyles,blockquote,panel,floatpanel,menu,contextmenu,resize,enterkey,entities,floatingspace,listblock,button,richcombo,format,horizontalrule,htmlwriter,indent,indentlist,list,magicline,maximize,removeformat,showborders,sourcearea,stylescombo,tab,dialogui,dialog,table,tabletools,undo,wysiwygarea,clipboard,SimpleLink,lineutils,widget,codesnippet,panelbutton,colorbutton,colordialog,symbol,justify,popup,filebrowser,toolbar,imageresize,image,filetools,notification,notificationaggregator,uploadwidget,uploadimage,elementspath';
 ...
 (function() {
  ...
  if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,horizontalrule,168,,indent-rtl,192,,indent,216,,outdent-rtl,240,,outdent,264,,bulletedlist-rtl,288,,bulletedlist,312,,numberedlist-rtl,336,,numberedlist,360,,maximize,384,,removeformat,408,,source-rtl,432,,source,456,,table,480,,redo-rtl,504,,redo,528,,undo-rtl,552,,undo,576,,copy-rtl,600,,copy,624,,cut-rtl,648,,cut,672,,paste-rtl,696,,paste,720,,simplelink,1488,auto,codesnippet,768,,bgcolor,792,,textcolor,816,,symbol,1680,auto,justifyblock,864,,justifycenter,888,,justifyleft,912,,justifyright,936,,image,960,', 'icons_hidpi.png');
  else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,horizontalrule,168,auto,indent-rtl,192,auto,indent,216,auto,outdent-rtl,240,auto,outdent,264,auto,bulletedlist-rtl,288,auto,bulletedlist,312,auto,numberedlist-rtl,336,auto,numberedlist,360,auto,maximize,384,auto,removeformat,408,auto,source-rtl,432,auto,source,456,auto,table,480,auto,redo-rtl,504,auto,redo,528,auto,undo-rtl,552,auto,undo,576,auto,copy-rtl,600,auto,copy,624,auto,cut-rtl,648,auto,cut,672,auto,paste-rtl,696,auto,paste,720,auto,simplelink,744,auto,codesnippet,768,auto,bgcolor,792,auto,textcolor,816,auto,symbol,840,auto,justifyblock,864,auto,justifycenter,888,auto,justifyleft,912,auto,justifyright,936,auto,image,960,auto', 'icons.png');
 })();
