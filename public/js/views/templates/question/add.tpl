<form action="/questions">
    <div class="form-horizontal">
        ...
        <div class="form-group folder">
            <label for="folder" class="control-label col-sm-1"><%= _t("folders.folder") %>:</label>
            <div class="col-sm-11 folder-select-wrapper"></div>
            <div class="error folder"></div>
        </div>

        <div class="form-group title">
            <label for="email" class="control-label col-sm-1"><%= _t("questions.title") %>:</label>
            <div class="col-sm-11">
        ...
        <div class="form-group folder">
            <label for="tag" class="control-label col-sm-1"><%= _t("tags.tags") %>:</label>
        ...
        <div class="description">
            <div class="row">
                <label for="description" class="control-label col-sm-1"><%= _t("questions.description") %>:</label>
            </div>
            <div>
