define([
    ...
    App.Answer.Models.Collection = Backbone.Collection.extend(
        _.extend({}, ModelMixins.LiveCollection, {
            model: App.Answer.Models.Model,
            url: function () {
    ...
    App.Answer.Models.CollectionByUser = PageableCollection.extend(
        _.extend({}, ModelMixins.LiveCollection, {
            model: App.Answer.Models.Model,
    ...
    var API = _.extend({}, ModelMixins.API, {
        getAnswers: function (question_id) {
            var answers = new App.Answer.Models.Collection({question_id: question_id});
            return this.deferOperation('fetch', answers);
        },

        answerCollectionByUser: function () {
            var answers = new App.Answer.Models.CollectionByUser();
            return this.deferOperation('fetch', answers);
        }
    });
